<script context="module">
	import { calculateStepPath, calculateRadius, calculatePath } from '../../utils/calculators';
...
<script>
	...
	function handleEdgeClick(event) {
		...
		console.log(
			`\u{1F5B1}\uFE0F \u041A\u043B\u0438\u043A \u043F\u043E \u0441\u043E\u0435\u0434\u0438\u043D\u0435\u043D\u0438\u044E: ${edgeKey}`
		);
		if (selectedEdgeStore && typeof selectedEdgeStore.set === 'function') {
			selectedEdgeStore.set(edgeKey);
			console.log(
				`\u2705 \u0421\u043E\u0435\u0434\u0438\u043D\u0435\u043D\u0438\u0435 ${edgeKey} \u0432\u044B\u0434\u0435\u043B\u0435\u043D\u043E`
			);
		} else {
			console.warn(
				'selectedEdgeStore \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D \u0438\u043B\u0438 \u043D\u0435 \u044F\u0432\u043B\u044F\u0435\u0442\u0441\u044F \u0441\u0442\u043E\u0440\u043E\u043C'
			);
		}
		if (edgeClick) {
			edgeClick();
